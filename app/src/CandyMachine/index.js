...
const config = new web3.PublicKey(
  "9bKWPyJ2PUZomQU7oL1GaiSbxFE5Jif3dPRheC7sGwyk"
);
...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getCandyMachineState = async () => {
    ...
    const candyMachine = await program.account.candyMachine.fetch(
      `GcAE9qC773TdfEDBDxYAeM7jaWkBEdAJV4g7EPSCiygq`
    );
  ...
  const mintToken = async () => {
    try {
      ...
      const accounts = {
        config,
        candyMachine: `GcAE9qC773TdfEDBDxYAeM7jaWkBEdAJV4g7EPSCiygq`,
        payer: walletAddress.publicKey,
        wallet: `JB7Z3Z4zWyuSKdPWePevG9nKD7ZX8Cn5xKddiqR7XVc`,
        mint: mint.publicKey,
        metadata,
        masterEdition,
